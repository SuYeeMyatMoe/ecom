...
SECRET_KEY = 'django-insecure-g2^)0a_36w(xyxm_+h^-7mv&fm(icml2s-a5w70(7iju9vyjjm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #use cart in create context processor in cart folder 
            ],
        },
    },
]
...
#BASE_DIR is defined in the above
